...
const BranchOffline: React.FC<BranchOfflineProps> = ({ branchName, onRestore, onLogout }) => {
  return (
      ...
      <div className="relative z-10 max-w-2xl w-full text-center space-y-12">
        ...
        <div className="flex flex-col items-center gap-6">
          {onLogout && (
            <button
              onClick={onLogout}
              className="px-8 py-3 rounded-xl border border-amber-500/20 text-amber-500 font-black text-[10px] uppercase tracking-widest hover:bg-amber-500/10 transition-all active:scale-95"
            >
